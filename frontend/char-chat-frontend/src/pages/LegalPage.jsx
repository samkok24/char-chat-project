...
const TERMS = {
  ...
  sections: [
    {
      heading: '제1조 (목적)',
      body: '이 약관은 챕터8(이하 "회사")가 제공하는 AI 캐릭터 채팅 서비스(이하 "서비스")의 이용 조건 및 절차, 회사와 회원의 권리·의무·책임사항을 규정함을 목적으로 합니다.',
    },
    {
      heading: '제2조 (정의)',
...
const REFUND = {
  ...
  sections: [
    ...
    {
      heading: '4. 환불 절차',
      body: '환불을 원하시는 경우, 서비스 내 문의하기 또는 cha8.team@gmail.com으로 요청해 주세요. 환불 요청 접수 후 영업일 기준 7일 이내에 처리됩니다.',
    },
    {
    ...
    {
      heading: '7. 문의',
      body: '환불 관련 문의: cha8.team@gmail.com',
    },
  ],
};
