...
const REFUND = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: '회사는 접수 후 확인 가능한 정보가 모두 충족된 시점부터 영업일 기준 3일 이내 1차 처리 결과를 안내하며, 최종 처리는 원칙적으로 영업일 기준 7일 이내 완료를 목표로 합니다. 환불은 원칙적으로 원 결제수단으로 진행하며, 결제대행사·카드사·앱마켓 정책에 따라 실제 입금/취소 반영 시점은 추가로 소요될 수 있습니다. 카드결제를 통한 구매 건의 환불은 원칙적으로 카드 매출 취소 환불을 통해서만 가능합니다.',
    },
    {
      heading: '8. 분쟁 및 이의제기',
